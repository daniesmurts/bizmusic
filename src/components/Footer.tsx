        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <a href="https://t.me/SmurtsTele_bot" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center border border-white/5 text-neutral-400 hover:text-neon hover:border-neon transition-all">
