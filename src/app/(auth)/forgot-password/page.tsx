  ...
  if (success) {
    return (
      <Card className="glass-dark border-white/10 text-white p-8 text-center animate-fade-in shadow-2xl shadow-neon/5">
        ...
        <Button asChild className="w-full bg-neon text-black hover:scale-105 font-black uppercase py-6 rounded-full transition-all">
      ...
      <CardContent className="px-8 pt-4 pb-10">
        <form onSubmit={handleResetRequest} className="space-y-6">
          ...
          <Button type="submit"
            ...
            {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : "Сбросить пароль"}
          </Button>
        </form>
      </CardContent>
    </Card>
