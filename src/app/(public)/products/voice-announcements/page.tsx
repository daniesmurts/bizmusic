    ...
    <div className="flex flex-col gap-16 md:gap-24 pb-20 animate-fade-in relative z-0">
      ...
      <section className="px-6 md:px-12 space-y-16">
        ...
        <div className="max-w-5xl mx-auto glass-dark border border-white/10 rounded-[2.5rem] p-8 md:p-10">
          <h3 className="text-2xl md:text-3xl font-black uppercase text-white tracking-tight mb-6">Пакеты токенов после месячного лимита</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { credits: "5 токенов", price: "150 ₽" },
              { credits: "10 токенов", price: "280 ₽" },
              { credits: "25 токенов", price: "625 ₽" },
              { credits: "50 токенов", price: "1 150 ₽" },
            ].map((pack) => (
          ...
          <p className="text-xs text-neutral-400 font-medium mt-5">Токены из пакетов переносятся и действуют 12 месяцев с даты покупки.</p>
        </div>
      </section>
