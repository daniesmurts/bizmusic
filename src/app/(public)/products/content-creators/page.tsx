  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white selection:bg-neon/30 selection:text-neon overflow-x-hidden">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        <Image
          src="/images/hero.png" // Placeholder due to generation error, will update if capacity allows
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="p-8 rounded-[2rem] bg-red-500/5 border border-red-500/10 space-y-4">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "TikTok удаляет контент с неочищенной музыкой",
                    "VK ограничивает монетизацию",
                    "Content ID Claims: даже при легальной покупке системы могут ошибаться"
                  ].map((p, i) => (
                    <li key={i} className="flex gap-3 text-neutral-400 font-medium">
          ...
          <div className="grid gap-6">
             {[
               ...
               <div key={i} className="glass-dark border border-white/5 p-8 rounded-[2rem] flex gap-6 group hover:border-white/10 transition-all">
                 <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-neon group-hover:text-black transition-all">
                   <item.icon className="w-6 h-6" />
                 </div>
                 <div className="space-y-2">
                   <h4 className="text-lg font-black uppercase tracking-tight text-white group-hover:text-neon transition-colors">{item.title}</h4>
        ...
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: "SMM-специалисты", items: ["Stories и Reels", "Рекламные креативы", "Корпоративные аккаунты"], badge: "Коммерческое использование ✅" },
              ...
              <div key={i} className="glass-dark border border-white/5 p-8 rounded-[2.5rem] flex flex-col justify-between group hover:border-white/10 transition-all">
                <div className="space-y-6">
                  <h3 className="text-2xl font-black uppercase tracking-tight text-white leading-none">{box.title}</h3>
                  <ul className="space-y-3">
      ...
      <section className="px-6 py-24">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="glass-dark border border-neon/20 p-12 rounded-[3rem] space-y-8">
            <div className="flex items-center gap-4">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tight text-white">Можно</h3>
            </div>
          ...
          <div className="glass-dark border border-red-500/20 p-12 rounded-[3rem] space-y-8">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-red-500/10 flex items-center justify-center">
                <Minus className="w-6 h-6 text-red-500" />
              </div>
              <h3 className="text-2xl font-black uppercase tracking-tight text-white">Нельзя</h3>
            </div>
            <ul className="space-y-4">
              {[
      ...
      <section className="px-6 py-24 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto glass-dark border border-white/10 rounded-[4rem] p-12 md:p-20 overflow-hidden relative">
          <div className="absolute top-0 right-0 p-40 bg-neon/5 blur-[120px] rounded-full -mr-40 -mt-40 pointer-events-none" />
          
          <div className="grid lg:grid-cols-2 gap-16 relative z-10">
            <div className="space-y-8">
              <div className="w-20 h-20 rounded-[2rem] bg-neon flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(92,243,135,0.4)]">
                <ShieldCheck className="w-10 h-10 text-black border-none" />
              </div>
              <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter text-white leading-none">Гарантия <br /><span className="text-neon outline-text">защиты</span></h2>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link href="mailto:daniel@boadtech.com">
                  <Button className="h-14 bg-white text-black hover:bg-neutral-200 transition-all font-black uppercase tracking-widest rounded-xl px-10">
                    Написать на почту
                  </Button>
                </Link>
                <Link href="https://t.me/your_telegram" target="_blank">
                  <Button variant="outline" className="h-14 border-white/20 text-white hover:bg-white/5 transition-all font-black uppercase tracking-widest rounded-xl px-10">
                    Telegram Поддержка
                  </Button>
                </Link>
              </div>
            ...
            <div className="bg-black/40 border border-white/5 p-10 rounded-[3rem] space-y-8">
              <h3 className="text-2xl font-black uppercase text-white border-b border-white/5 pb-6">Наша гарантия🛡️</h3>
              <div className="space-y-6">
                {[
