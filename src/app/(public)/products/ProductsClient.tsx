...
const products = [
  ...
  },
  {
    ...
    description: "Автоматические аудиоанонсы и информирование",
    longDescription:
      "Увеличивайте продажи и информируйте клиентов без участия персонала. Идеально для анонсов акций, специальных предложений и навигации в помещении.",
    icon: Mic2,
